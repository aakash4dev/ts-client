...
export interface MsgAddExecutionLayer {
  creator: string;
  verificationKey: string;
  chainInfo: string;
}

export interface MsgAddExecutionLayerResponse {
  id: number;
  chainId: string;
}
...
function createBaseMsgAddExecutionLayer(): MsgAddExecutionLayer {
  return { creator: "", verificationKey: "", chainInfo: "" };
}

export const MsgAddExecutionLayer = {
  encode(message: MsgAddExecutionLayer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.verificationKey !== "") {
      writer.uint32(18).string(message.verificationKey);
    }
    if (message.chainInfo !== "") {
      writer.uint32(26).string(message.chainInfo);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgAddExecutionLayer {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgAddExecutionLayer();
  ...
  fromJSON(object: any): MsgAddExecutionLayer {
    return {
  ...
  toJSON(message: MsgAddExecutionLayer): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddExecutionLayer>, I>>(object: I): MsgAddExecutionLayer {
    const message = createBaseMsgAddExecutionLayer();
...
function createBaseMsgAddExecutionLayerResponse(): MsgAddExecutionLayerResponse {
  return { id: 0, chainId: "" };
}

export const MsgAddExecutionLayerResponse = {
  encode(message: MsgAddExecutionLayerResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgAddExecutionLayerResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgAddExecutionLayerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgAddExecutionLayerResponse {
    return {
  ...
  toJSON(message: MsgAddExecutionLayerResponse): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddExecutionLayerResponse>, I>>(object: I): MsgAddExecutionLayerResponse {
    const message = createBaseMsgAddExecutionLayerResponse();
...
export interface Msg {
  AddExecutionLayer(request: MsgAddExecutionLayer): Promise<MsgAddExecutionLayerResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc) {
    this.rpc = rpc;
    this.AddExecutionLayer = this.AddExecutionLayer.bind(this);
    this.CreatePost = this.CreatePost.bind(this);
    this.UpdatePost = this.UpdatePost.bind(this);
    this.DeletePost = this.DeletePost.bind(this);
  }
  AddExecutionLayer(request: MsgAddExecutionLayer): Promise<MsgAddExecutionLayerResponse> {
    const data = MsgAddExecutionLayer.encode(request).finish();
    const promise = this.rpc.request("airhub.airhub.Msg", "AddExecutionLayer", data);
    return promise.then((data) => MsgAddExecutionLayerResponse.decode(new _m0.Reader(data)));
  }

  CreatePost(request: MsgCreatePost): Promise<MsgCreatePostResponse> {
    const data = MsgCreatePost.encode(request).finish();
    const promise = this.rpc.request("airhub.airhub.Msg", "CreatePost", data);
    return promise.then((data) => MsgCreatePostResponse.decode(new _m0.Reader(data)));
  }

  UpdatePost(request: MsgUpdatePost): Promise<MsgUpdatePostResponse> {
    const data = MsgUpdatePost.encode(request).finish();
    const promise = this.rpc.request("airhub.airhub.Msg", "UpdatePost", data);
    return promise.then((data) => MsgUpdatePostResponse.decode(new _m0.Reader(data)));
  }

  DeletePost(request: MsgDeletePost): Promise<MsgDeletePostResponse> {
    const data = MsgDeletePost.encode(request).finish();
    const promise = this.rpc.request("airhub.airhub.Msg", "DeletePost", data);
